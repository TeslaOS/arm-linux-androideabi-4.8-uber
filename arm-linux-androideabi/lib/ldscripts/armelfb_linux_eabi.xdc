...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/cl3kener/android/toolchain/uber/out/arm-linux-androideabi-4.8/arm-linux-androideabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
